  ...
  const features = [
    {
      ...
      description:
        "Conectamos mascotas con familias perfectas a través de un proceso cuidadoso y estructurado.",
    },
    {
      icon: Users,
      title: "Proceso Seguro",
      description:
        "Verificamos cada solicitud para garantizar el bienestar y la seguridad de nuestras mascotas.",
    },
    {
      icon: Award,
      title: "Seguimiento Continuo",
      description:
        "Acompañamos a las familias después de la adopción para asegurar una transición exitosa.",
    },
    {
      icon: Shield,
      title: "Compromiso de Calidad",
      description:
        "Trabajamos con refugios certificados y veterinarios especializados en bienestar animal.",
    },
  ];
    ...
    >
      <div className="min-h-screen bg-white/60">
            ...
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:block">
                <div className="ml-10 flex items-baseline space-x-4">
                  <a
                    href="#inicio"
                    className="text-white hover:text-primary-300 px-3 py-2 text-sm font-medium"
                  >
                    Inicio
                  </a>
                  <a
                  ...
                  <a
                    href="#proceso"
                    className="text-white hover:text-primary-500 px-3 py-2 text-sm font-medium"
                  >
                    Proceso
                  </a>
                  <a
                    href="#contacto"
                    className="text-white/80 hover:text-primary-500 px-3 py-2 text-sm font-medium"
                  >
                    Contacto
                  </a>
                </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white/80 border-t backdrop-blur-sm">
              <div className="px-2 pt-2 pb-3 space-y-1">
                <a
                  href="#inicio"
                  className="block px-3 py-2 text-white/80 font-medium"
                >
                  Inicio
                </a>
                <a
                  href="#mascotas"
                  className="block px-3 py-2 text-white/80 hover:text-primary-500"
                >
                  Mascotas
                </a>
                <a
                ...
                <div className="border-t pt-2 mt-2">
                  <Link
                    to="/login"
                    className="block px-3 py-2 text-white hover:text-white"
                  >
                    Iniciar Sesión
                  </Link>
                  <Link
        ...
        <section id="inicio" className="py-20 px-4 text-center">
          <div className="max-w-7xl mx-auto bg-white/80 rounded-xl p-10 backdrop-blur-sm">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900/90 mb-6">
              Encuentra a tu{" "}
              <span className="text-primary-500 block">Compañero Perfecto</span>
            </h1>
            <p className="text-xl text-gray-700/80 mb-8 max-w-3xl mx-auto">
              ...
              amor incondicional. Nuestro proceso de adopción responsable
              garantiza matches perfectos para toda la vida.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/register"
                className="bg-primary-500 text-black px-8 py-4 rounded-lg text-lg font-medium hover:bg-primary-600/90 transition-all transform hover:-translate-y-1 hover:shadow-lg inline-flex items-center justify-center"
              >
        ...
        <section id="mascotas" className="py-16 px-4">
          <div className="max-w-7xl mx-auto bg-white/80 rounded-xl p-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {stats.map((stat, i) => (
                <div key={i}>
                  <div className="text-3xl md:text-4xl font-bold text-primary-500/90 mb-2">
                    {stat.number}
                  </div>
                  <div className="text-gray-600/80 font-medium">
                    {stat.label}
                  </div>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16 bg-white/70 p-6 rounded-xl">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900/90 mb-4">
                ¿Por qué elegir PetMatch?
              </h2>
              <p className="text-xl text-gray-600/80 max-w-2xl mx-auto">
                Nuestro compromiso va más allá de la adopción. Creamos vínculos
                duraderos entre mascotas y familias.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, i) => (
                <div
                  key={i}
                  className="bg-white/70 p-6 rounded-xl shadow-sm hover:shadow-md"
                >
                  ...
                  <h3 className="text-xl font-semibold text-gray-900/90 mb-2">
                    {feature.title}
                  </h3>
        ...
        <section
          id="contacto"
          className="py-20 bg-primary-500 text-center text-white px-4"
        >
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8">
              Miles de mascotas están esperando encontrar su hogar para siempre.
              Comienza tu proceso de adopción hoy mismo.
            </p>
            <Link
              to="/register"
              className="bg-[#1f2937]/90 text-primary-500 px-8 py-4 rounded-lg text-lg font-medium hover:bg-white inline-flex items-center"
            >
              Adoptar Ahora{" "}
              <img
                src="/dog.png"

      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Encuentra a tu compañero perfecto entre nuestras{" "}
            {filteredPets.length} mascotas disponibles.
          </p>
        </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center text-xs text-gray-500">
                      ...
                      <span>
                        Agregado {new Date(pet.createdAt).toLocaleDateString()}
                      </span>
                    </div>
        ...
        <div className="bg-primary-500 rounded-lg p-8 text-center text-white">
          ...
          <p className="text-primary-100 mb-6">
            Regístrate para comenzar el proceso de adopción y darle un hogar
            lleno de amor.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/register"
              className="bg-white text-primary-500 px-6 py-3 rounded-lg font-medium hover:bg-gray-50 transition-colors"
            >
              Comenzar Adopción
            </Link>

  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
      <div className="bg-white p-6 rounded shadow-lg max-w-md w-full relative">
        ...
        <h2 className="text-xl font-semibold mb-4">{actionType === 'approved' ? 'Aprobar' : 'Rechazar'} solicitud</h2>

        <label className="block mb-2 font-medium">Observaciones (opcional):</label>
        <textarea
          value={observations}
